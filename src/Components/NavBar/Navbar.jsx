...
const Navbar = () => {
  ...
  useEffect(() => {
    document.body.classList.add('pt-[73px]', 'md:pt-[73px]', 'customDesktop:pt-[85px]', '3xl:pt-[100px]', '4xl:pt-[120px]');
    return () => {
      document.body.classList.remove('pt-[73px]', 'md:pt-[73px]', 'customDesktop:pt-[85px]', '3xl:pt-[100px]', '4xl:pt-[120px]');
    };
  }, []);
