...
const HomeEight = () => {
  ...
  const [phoneNumber, setPhoneNumber] = useState("(888) 212-8149");
    ...
    return (
        <div>
            <div className="w-full relative bg-[#faf3ec]  items-center justify-center  overflow-hidden text-left text-[20px] text-[#4b2c5e] font-helvetica hidden md:block 4xl:pb-32">
                <div className="w-[1207px] relative h-[645px] text-[96px] lg:text-[67px] sm:text-[67px] font-georgia ml-[100px] mt-0 2xl:ml-[33%] 2xl:mt-0 max-w-[105rem]">
                    {" "}
                    {/* Added negative margin-left */}
                    <div className="relative w-full h-auto flex items-center justify-center gap-0 md:gap-2 lg:gap-4 xl:gap-6 px-2 sm:px-6 md:px-12 xl:px-24 mx-auto">
                        <img
            ...
            <div className="block md:hidden w-full relative bg-[#faf3ec] py-16 px-4 text-[#4b2c5e] font-helvetica">
                <div className="flex flex-col items-center">
                    ...
                    {/* Second row with image and button below */}
                    <div className="relative w-full max-w-[400px]">
                        <img
                            className="w-full h-full mx-auto mb-4 relative z-10"
                            alt=""
                            src={Img4}
                        />
                        {/* Button positioned below the image - smaller and centered */}
                        <div className="relative w-full">
                            <div
                                className="absolute top-[calc(50%-65px)] z-10 left-1/2 transform -translate-x-1/2 inline-flex rounded-[8px] bg-[#4b2c5e] py-[6px] px-[12px] justify-center items-center text-[#f8f2e9] font-helvetica text-[12px] font-normal leading-normal cursor-pointer hover:bg-[#3a1f47] transition-colors duration-200"
